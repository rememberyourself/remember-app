...
export default function NavBar() {
  ...
  return (
    <>
      {/* Top bar */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-forest-900/80 backdrop-blur-xl border-b border-forest-700/50" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
