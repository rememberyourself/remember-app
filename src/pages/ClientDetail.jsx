...
function ThreadMessageCoach({ msg }) {
  ...
  const label = isCoach ? <><img src="/icons/coach-response.png" alt="" className="w-8 h-8 inline" /> You (Coach)</> : <><img src="/icons/client-reply.svg" alt="" className="w-10 h-10 inline" /> Client</>;
