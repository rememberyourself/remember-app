...
function ThreadMessage({ msg, isCoach }) {
  ...
  const label = isCoach ? <><img src="/icons/coach-response.png" alt="" className="w-8 h-8 inline" /> Coach</> : <><img src="/icons/client-reply.png" alt="" className="w-7 h-7 inline" /> You</>;
